    ...
    private function downloadCsv(int $userId, ClientFiltersDTO $filters, string $filename): Response
    {
        ...
        foreach ($clients as $client) {
            $row = [
                ...
                $this->cell($client->status instanceof \App\Modules\CRM\Enums\ClientStatus ? $client->status->value : (string)($client->status ?? '')),
                $this->cell($client->source instanceof \App\Modules\CRM\Enums\ClientSource ? $client->source->value : (string)($client->source ?? '')),
