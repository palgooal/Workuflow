...
@section('breadcrumb')
    ...
    <span class="text-gray-700">الفريق</span>
@endsection
...
<div class="space-y-5">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl font-bold text-gray-900">الفريق</h1>
            <p class="mt-1 text-sm text-gray-500">{{ $teamMembers->count() }} عضو مسجّل</p>
        </div>
    ...
    @if($teamMembers->isEmpty())
        <div class="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h3 class="text-sm font-semibold text-gray-900">لا يوجد أعضاء في الفريق بعد</h3>
            <p class="mt-1 text-sm text-gray-400">أضف موظفين أو فريلانسرين لتعيينهم على مشاريعك</p>
            <a href="{{ route('team.create') }}"
