...
<div class="max-w-2xl mx-auto space-y-6"
    ...
    {{-- Tab Navigation --}}
    <div class="flex gap-1 bg-slate-100 rounded-xl p-1" role="tablist" aria-label="أقسام الإعدادات">

        {{-- الملف الشخصي --}}
        <button @click="tab = 'profile'; window.location.hash = 'profile'"
                :class="tab === 'profile' ? 'bg-white text-ink shadow-sm' : 'text-muted hover:text-ink'"
                ...
                role="tab" :aria-selected="tab === 'profile'" aria-controls="profile">
        ...
        {{-- قالب الفاتورة --}}
        <button @click="tab = 'invoice'; window.location.hash = 'invoice'"
                :class="tab === 'invoice' ? 'bg-white text-ink shadow-sm' : 'text-muted hover:text-ink'"
                class="flex-1 inline-flex items-center justify-center gap-1.5 py-2 px-3 text-xs sm:text-sm font-medium rounded-lg transition"
                role="tab" :aria-selected="tab === 'invoice'" aria-controls="invoice">
            <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        {{-- الأمان --}}
        <button @click="tab = 'security'; window.location.hash = 'security'"
                :class="tab === 'security' ? 'bg-white text-ink shadow-sm' : 'text-muted hover:text-ink'"
                class="flex-1 inline-flex items-center justify-center gap-1.5 py-2 px-3 text-xs sm:text-sm font-medium rounded-lg transition"
                role="tab" :aria-selected="tab === 'security'" aria-controls="security">
            <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        {{-- التفضيلات --}}
        <button @click="tab = 'preferences'; window.location.hash = 'preferences'"
                :class="tab === 'preferences' ? 'bg-white text-ink shadow-sm' : 'text-muted hover:text-ink'"
                class="flex-1 inline-flex items-center justify-center gap-1.5 py-2 px-3 text-xs sm:text-sm font-medium rounded-lg transition"
                role="tab" :aria-selected="tab === 'preferences'" aria-controls="preferences">
            <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round"
                      d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826
                         ...
                         0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572
                         c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37
        ...
        <button @click="tab = 'plan'; window.location.hash = 'plan'"
                ...
                class="flex-1 inline-flex items-center justify-center gap-1.5 py-2 px-3 text-xs sm:text-sm font-medium rounded-lg transition"
                role="tab" :aria-selected="tab === 'plan'" aria-controls="plan">
            <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round"
