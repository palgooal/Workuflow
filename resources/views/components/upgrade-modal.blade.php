{{--
    Upgrade Modal — يظهر تلقائياً عند وجود session upgrade_prompt
    يُدرج في layouts/app.blade.php مرة واحدة
--}}
    ...
    <div class="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-md p-6 space-y-5"
        ...
        <div class="flex flex-col items-center text-center gap-3 pt-2">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ $prompt['message'] }}</p>
            </div>
        </div>
