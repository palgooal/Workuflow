        ...
        <div class="bg-white rounded-xl border border-gray-100 p-5 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="url" name="website" value="{{ old('website') }}"
                           ...
                           class="w-full px-4 py-2.5 text-sm border rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none
                                  {{ $errors->has('website') ? 'border-red-400 bg-red-50' : 'border-gray-200' }}">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">الدولة <span class="text-gray-400 text-xs">(رمز دولة مكوّن من حرفين: PS، IL…)</span></label>
                    <input type="text" name="country" value="{{ old('country', 'PS') }}"
                           placeholder="PS" maxlength="2"
                           class="w-full px-4 py-2.5 text-sm border rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none
                                  {{ $errors->has('country') ? 'border-red-400 bg-red-50' : 'border-gray-200' }}">
            ...
            <div>
                ...
                <textarea name="notes" rows="3" placeholder="أي ملاحظات إضافية عن العميل…"
                          class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl
                                 focus:ring-2 focus:ring-indigo-500 outline-none resize-none">{{ old('notes') }}</textarea>
            </div>
        </div>
