<?php $__env->startSection('title', 'إضافة دين جديد'); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <a href="<?php echo e(route('debts.index')); ?>" class="hover:text-gray-700">الديون</a>
...
<div class="max-w-xl mx-auto">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 p-6"
         x-data="{
             type: '<?php echo e(old('type', 'borrowed')); ?>',
             get typeLabel() {
                 return this.type === 'borrowed' ? 'دين عليّ (اقترضت)' : 'دين لي (أقرضت)';
             }
         }">

        <form method="POST" action="<?php echo e(route('debts.store')); ?>" class="space-y-5">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <input type="text" id="party_name" name="party_name"
                       value="<?php echo e(old('party_name')); ?>" required
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['party_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="grid grid-cols-3 gap-3">
                <div class="col-span-2">
                    ...
                    <input type="number" id="amount" name="amount"
                           value="<?php echo e(old('amount')); ?>" required min="0.01" step="0.01"
                           placeholder="0.00"
                           class="w-full px-4 py-2.5 rounded-xl border border-gray-200
                                  focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm">
                ...
                <div>
                    ...
                    <select id="currency" name="currency"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cur); ?>" <?php echo e(old('currency', 'SAR') === $cur ? 'selected' : ''); ?>>
                                <?php echo e($cur); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <textarea id="notes" name="notes" rows="3"
                          ...
                          class="w-full px-4 py-2.5 rounded-xl border border-gray-200
                                 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm resize-none"><?php echo e(old('notes')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\laragon\www\Workuflow\resources\views/debts/create.blade.php ENDPATH**/ ?>