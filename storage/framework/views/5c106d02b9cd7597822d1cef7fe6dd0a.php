...
<span class="relative inline-block text-brand/95">
المال والعمل
</span>
...
من مكان واحد
            ...
            <div class="relative mx-auto max-w-[68rem]">
                ...
                <div
                    class="relative rounded-[1.75rem] border border-white/60 bg-white/55 p-2 shadow-[0_12px_30px_rgba(15,23,42,.07)] backdrop-blur-xl">
                    <div
                        ...
                        <div
                            ...
                            <div
                                class="mx-1 flex h-7 min-w-0 flex-1 items-center justify-center rounded-xl border border-white/[0.05] bg-white/[0.035] px-3">
                                <span
                                    class="truncate text-[0.68rem] font-medium text-slate-300/80">darahum.com/dashboard</span>
                            </div>
                            <div class="hidden flex-shrink-0 items-center gap-2 sm:flex">
                                <span class="h-7 w-7 rounded-xl border border-white/[0.04] bg-white/[0.025]"></span>
                                <span class="h-7 w-7 rounded-xl border border-white/[0.04] bg-white/[0.025]"></span>
                            </div>
                        </div>
                        ...
                        <div class="flex h-[400px] sm:h-[430px] lg:h-[440px]">
                            ...
                            <aside
                                ...
                                <div class="flex-1 space-y-1.5">
                                    <div
                                        class="flex items-center gap-2.5 rounded-xl border border-white/[0.05] bg-white/[0.05] px-3 py-2.5 text-xs font-semibold text-white shadow-[inset_0_1px_0_rgba(255,255,255,.04)]">
                                    ...
                                    <div
                                        class="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-xs font-medium text-slate-400 transition-colors duration-200 hover:bg-white/[0.03] hover:text-slate-200">
                                ...
                                <div class="mt-4 rounded-xl border border-white/[0.05] bg-white/[0.03] p-3">
                                ...
                                <div class="mt-3 flex items-center gap-2 border-t border-white/[0.05] pt-3">
                                    <div
                                ...
                                <div class="flex h-full min-h-0 flex-col gap-3 lg:gap-4">
                                    ...
                                    <div class="flex flex-shrink-0 items-start justify-between gap-3">
                                        ...
                                        <div class="flex flex-shrink-0 items-center gap-2">
                                            <div
                                                class="hidden rounded-lg border border-white/[0.06] bg-white/[0.035] px-2.5 py-1.5 text-[0.65rem] font-medium text-slate-400 sm:block">
                                                آخر ٣٠ يوم
                                            </div>
                                            <div
                                                class="relative flex h-8 w-8 items-center justify-center rounded-lg border border-white/[0.055] bg-white/[0.03]">
                                                <span
                                    ...
                                    <div class="grid flex-shrink-0 grid-cols-2 gap-2 sm:grid-cols-4 lg:gap-3">
                                        <div
                                            ...
                                            <div class="mb-3 flex items-center justify-between gap-2">
                                                ...
                                                <span
                                                    class="rounded-full bg-accent/[0.09] px-1.5 py-0.5 text-[0.55rem] font-bold text-accent">↑
                                                    ١٢٪</span>
                                            </div>
                                        ...
                                        <div
                                            class="rounded-xl border border-white/[0.05] bg-white/[0.035] p-3.5 shadow-[inset_0_1px_0_rgba(255,255,255,.028)]">
                                            <div class="mb-3 flex items-center justify-between gap-2">
                                                <span
                                                    class="text-[0.62rem] font-semibold text-slate-400">المصروفات</span>
                                                <span
                                                    class="rounded-full bg-white/[0.052] px-1.5 py-0.5 text-[0.55rem] font-bold text-slate-300">↑
                                                    ٣٪</span>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="mb-3 flex items-center justify-between gap-2">
                                                <span class="text-[0.62rem] font-semibold text-slate-400">غير
                                                    مدفوع</span>
                                                <span
                                                    class="rounded-full bg-brand/20 px-1.5 py-0.5 text-[0.55rem] font-bold text-slate-200">٣
                                                    فواتير</span>
                                            </div>
                                    ...
                                    <div class="grid min-h-0 flex-1 grid-cols-1 gap-3 lg:grid-cols-5">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="absolute inset-x-0 top-0 h-px bg-white/[0.035]"></div>
                                                <div class="absolute inset-x-0 top-1/3 h-px bg-white/[0.035]"></div>
                                                <div class="absolute inset-x-0 top-2/3 h-px bg-white/[0.035]"></div>
                                                <div class="relative flex flex-1 flex-col items-center gap-2">
                                                    <div class="flex h-28 w-full items-end gap-1">
                                                        <div class="flex-1 rounded-t-md bg-accent/[0.28] h-[60%]">
                                                        </div>
                                                        <div class="flex-1 rounded-t-md bg-slate-600/[0.28] h-[35%]">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="relative flex flex-1 flex-col items-center gap-2">
                                                    <div class="flex h-28 w-full items-end gap-1">
                                                        <div class="flex-1 rounded-t-md bg-accent/[0.38] h-[45%]">
                                                        </div>
                                                        <div class="flex-1 rounded-t-md bg-slate-600/[0.32] h-[25%]">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="relative flex flex-1 flex-col items-center gap-2">
                                                    <div class="flex h-28 w-full items-end gap-1">
                                                        <div class="flex-1 rounded-t-md bg-accent/[0.48] h-[75%]"></div>
                                                        <div class="flex-1 rounded-t-md bg-slate-600/[0.36] h-[40%]">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="relative flex flex-1 flex-col items-center gap-2">
                                                    <div class="flex h-28 w-full items-end gap-1">
                                                        <div class="flex-1 rounded-t-md bg-accent/[0.59] h-[50%]">
                                                        </div>
                                                        <div class="flex-1 rounded-t-md bg-slate-600/[0.4] h-[28%]">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="relative flex flex-1 flex-col items-center gap-2">
                                                    <div class="flex h-28 w-full items-end gap-1">
                                                        <div
                                                            class="flex-1 rounded-t-md bg-accent/72 h-[85%]">
                                                        </div>
                                                        <div class="flex-1 rounded-t-md bg-slate-600/[0.44] h-[45%]">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="relative flex flex-1 flex-col items-center gap-2">
                                                    <div class="flex h-28 w-full items-end gap-1">
                                                        <div
                                                            class="flex-1 rounded-t-md bg-accent/[0.92] h-[70%] shadow-[0_0_6px_rgba(20,198,152,.06)]">
                                                        </div>
                                                        <div class="flex-1 rounded-t-md bg-slate-600/[0.48] h-[35%]">
                                                        </div>
                                                    </div>
                                        ...
                                        <div
                                            ...
                                            <div class="min-h-0 flex-1 space-y-2 overflow-hidden">
                                                <div
                                                    class="flex items-center justify-between rounded-xl bg-white/[0.024] px-3 py-2">
                                                    <div class="flex min-w-0 items-center gap-2">
                                                        <div
                                                            class="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg bg-accent/[0.06]">
                                                ...
                                                <div class="flex items-center justify-between rounded-xl px-3 py-2">
                                                    <div class="flex min-w-0 items-center gap-2">
                                                        <div
                                                            class="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg bg-white/[0.05]">
