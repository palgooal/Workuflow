<?php $__env->startSection('title', 'دراهم — الأسعار'); ?>

<?php $__env->startSection('body-class', 'font-sans text-g-body bg-g-light overflow-x-hidden'); ?>
...
<script src="<?php echo e(asset('marketing/js/pricing.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.marketing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\laragon\www\Workuflow\resources\views/marketing/pricing.blade.php ENDPATH**/ ?>