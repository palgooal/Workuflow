...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'دراهم — المنصة المالية للمستقلين'); ?></title>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('marketing/css/output.css')); ?>" />

  <?php echo $__env->yieldContent('head'); ?>
</head>

<body class="<?php echo $__env->yieldContent('body-class', 'bg-white text-g-dark antialiased overflow-x-hidden font-sans'); ?>">
  ...
  <header id="navbar"
    ...
    <div class="max-w-[1280px] mx-auto px-10">
      <div class="flex items-center justify-between h-20 px-6">
        ...
        <div class="flex items-center gap-12">
          <a href="<?php echo e(route('home')); ?>" aria-label="دراهم - الرئيسية">
            <img src="<?php echo e(asset('marketing/imgs/logo.png')); ?>" alt="دراهم" width="88" height="44"
              class="w-[88px] h-[44px] object-contain" />
          </a>

          <nav class="hidden md:flex items-center gap-8">
            <a href="<?php echo e(route('marketing.features')); ?>"
              class="font-medium text-base transition-colors <?php echo e(request()->routeIs('marketing.features') ? 'text-g-green' : 'text-g-body hover:text-g-green'); ?>">المميزات</a>
            <a href="<?php echo e(route('marketing.pricing')); ?>"
              class="font-medium text-base transition-colors <?php echo e(request()->routeIs('marketing.pricing') ? 'text-g-green' : 'text-g-body hover:text-g-green'); ?>">الأسعار</a>
            <a href="<?php echo e(route('marketing.faq')); ?>"
              class="font-medium text-base transition-colors <?php echo e(request()->routeIs('marketing.faq') ? 'text-g-green' : 'text-g-body hover:text-g-green'); ?>">الأسئلة الشائعة</a>
            <a href="#"
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-g-border">
      <nav class="flex flex-col px-6 py-4 gap-1">
        <a href="<?php echo e(route('marketing.features')); ?>"
          class="py-3 border-b border-g-border/50 <?php echo e(request()->routeIs('marketing.features') ? 'text-g-green font-semibold' : 'text-g-body'); ?>">المميزات</a>
        <a href="<?php echo e(route('marketing.pricing')); ?>"
          class="py-3 border-b border-g-border/50 <?php echo e(request()->routeIs('marketing.pricing') ? 'text-g-green font-semibold' : 'text-g-body'); ?>">الأسعار</a>
        <a href="<?php echo e(route('marketing.faq')); ?>"
          class="py-3 border-b border-g-border/50 <?php echo e(request()->routeIs('marketing.faq') ? 'text-g-green font-semibold' : 'text-g-body'); ?>">الأسئلة الشائعة</a>
        <a href="#" class="py-3 border-b border-g-border/50 text-g-body">المدونة</a>
        <a href="<?php echo e(route('login')); ?>" class="pt-4 pb-2 text-center font-bold text-g-purple-mid">تسجيل الدخول</a>
        <a href="<?php echo e(route('register')); ?>"
  ...
  <footer class="bg-g-light border-t border-g-border py-20 px-5">
    <div class="max-w-[1200px] mx-auto px-6 flex flex-col gap-16">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div class="flex flex-col gap-6 items-start text-start">
          ...
          <ul class="flex flex-col gap-4">
            <li><a href="<?php echo e(route('marketing.features')); ?>" class="text-g-body text-sm hover:text-g-green transition-colors">المميزات</a></li>
            <li><a href="<?php echo e(route('marketing.pricing')); ?>" class="text-g-body text-sm hover:text-g-green transition-colors">الأسعار</a></li>
            <li><a href="#" class="text-g-body text-sm hover:text-g-green transition-colors">المدونة</a></li>
            <li><a href="<?php echo e(route('marketing.faq')); ?>" class="text-g-body text-sm hover:text-g-green transition-colors">الأسئلة الشائعة</a></li>
          </ul>
        </div>
      ...
      <div class="border-t border-g-border pt-8 flex flex-col-reverse md:flex-row items-center justify-between gap-4">
        <p class="text-xs text-black/40">© <?php echo e(date('Y')); ?> دراهم. جميع الحقوق محفوظة.</p>
  ...
  <script src="<?php echo e(asset('marketing/js/jquery-3.7.1.min.js')); ?>"></script>
  <script src="<?php echo e(asset('marketing/js/script.js')); ?>"></script>
  <?php echo $__env->yieldContent('scripts'); ?>
</body>

</html>
<?php /**PATH F:\laragon\www\Workuflow\resources\views/layouts/marketing.blade.php ENDPATH**/ ?>