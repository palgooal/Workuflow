        ...
        <div class="p-8">
            ...
            <div x-show="step === 1">
                ...
                <div class="grid grid-cols-3 gap-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [['📁','مشاريع'],['💸','معاملات'],['📊','تقارير']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$emoji, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="p-3 bg-gray-50 rounded-xl text-center">
                        <span class="text-2xl"><?php echo e($emoji); ?></span>
                        <p class="text-xs text-gray-600 mt-1 font-medium"><?php echo e($label); ?></p>
                    </div>
            ...
            <div x-show="step === 2">
                ...
                <div class="space-y-2.5">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$text, $tc, $bg]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
