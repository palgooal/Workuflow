...
<div class="max-w-4xl mx-auto space-y-4">
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-2 flex-wrap print:hidden" x-data="{ showSendModal: false }">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoice->status !== \App\Support\Enums\InvoiceStatus::Cancelled): ?>
            ...
            ?>
            <button onclick="sendWhatsappWithPdf('<?php echo e($whatsappUrl); ?>', '<?php echo e($pdfUrl); ?>')"
            ...
            <a href="<?php echo e(route('invoices.pdf', $invoice->ulid)); ?>" target="_blank"
                ...
                <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 space-y-4" @click.stop>
                    ...
                    <div class="bg-gray-50 rounded-xl p-3 text-sm space-y-1.5">
                        <div class="flex justify-between text-gray-500">
                            <span>الفاتورة</span>
                            <span class="font-semibold text-gray-800"><?php echo e($invoice->number); ?></span>
                        </div>
                        <div class="flex justify-between text-gray-500">
                            <span>العميل</span>
                            <span class="font-semibold text-gray-800"><?php echo e($invoice->client->name); ?></span>
                        </div>
                        <div class="flex justify-between text-gray-500">
                            <span>المبلغ</span>
                            <span class="font-bold text-indigo-700"><?php echo e(number_format($invoice->total, 2)); ?> <?php echo e($invoice->currency); ?></span>
                        </div>
                    </div>
                    <form method="POST" action="<?php echo e(route('invoices.send-client', $invoice->ulid)); ?>" class="space-y-3">
                        <?php echo csrf_field(); ?>
                        <div>
                            ...
                            <input type="email" name="recipient_email"
                                   value="<?php echo e(old('recipient_email', $invoice->client->email ?? '')); ?>"
                            ...
                            <p class="text-xs text-gray-400 mt-1">سيُرسَل باسمك (<?php echo e(auth()->user()->name); ?>) مع تفاصيل الفاتورة.</p>
                        </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm print:shadow-none print:border-0" id="invoice-paper">
        ...
        <div class="flex justify-end mb-6">
            <div class="w-64 space-y-2 text-sm">
                ...
                <div class="flex justify-between text-gray-600">
                    <span>الخصم</span>
                    <span>- <?php echo e(number_format($invoice->discount, 2)); ?> <?php echo e($invoice->currency); ?></span>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex justify-between text-gray-600">
                    <span>الضريبة</span>
                    <span><?php echo e(number_format($invoice->tax, 2)); ?> <?php echo e($invoice->currency); ?></span>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div class="flex justify-between font-bold text-gray-900 border-t border-gray-200 pt-2">
                    <span>الإجمالي</span>
                    <span><?php echo e(number_format($invoice->total, 2)); ?> <?php echo e($invoice->currency); ?></span>
                </div>
            </div>
        </div>
