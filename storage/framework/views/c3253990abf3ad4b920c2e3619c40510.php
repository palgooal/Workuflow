...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <select name="currency"
                            class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none bg-white">
                        <option value="ILS" <?php echo e(old('currency', 'ILS') === 'ILS' ? 'selected' : ''); ?>>₪ شيكل (ILS)</option>
                        <option value="USD" <?php echo e(old('currency') === 'USD' ? 'selected' : ''); ?>>$ دولار (USD)</option>
                        <option value="EUR" <?php echo e(old('currency') === 'EUR' ? 'selected' : ''); ?>>€ يورو (EUR)</option>
                        <option value="JOD" <?php echo e(old('currency') === 'JOD' ? 'selected' : ''); ?>>د.أ دينار (JOD)</option>
                    </select>
                </div>
