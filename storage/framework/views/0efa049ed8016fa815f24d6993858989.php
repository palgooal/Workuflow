...
<head>
    ...
    <title><?php echo e(config('app.name', 'دراهم')); ?><?php echo e(isset($title) ? ' — ' . $title : ''); ?></title>
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800 flex-col justify-between p-12">
        <div>
            ...
            <div class="mt-12 space-y-5">
                ...
                <div class="flex items-center gap-3">
                    <span class="text-2xl"><?php echo e($feature['icon']); ?></span>
                    <span class="text-indigo-100"><?php echo e($feature['text']); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>

        <p class="text-indigo-300 text-sm">© <?php echo e(date('Y')); ?> دراهم. جميع الحقوق محفوظة.</p>
    </div>
...
<?php /**PATH F:\laragon\www\Workuflow\resources\views/layouts/guest.blade.php ENDPATH**/ ?>