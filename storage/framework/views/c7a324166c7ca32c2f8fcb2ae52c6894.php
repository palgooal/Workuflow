...
<div class="space-y-5" x-data="clientProfile()">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div class="bg-white rounded-xl border border-gray-100 p-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($revenueByCurrency)): ?>
                <p class="text-2xl font-bold text-gray-300">—</p>
            <?php else: ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $revenueByCurrency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cur => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <p class="font-bold text-gray-900 <?php echo e($multiCurrency ? 'text-lg' : 'text-2xl'); ?>">
                    <?php echo e(number_format($amount, 0)); ?>

                    <span class="text-sm font-normal text-gray-400"><?php echo e($cur); ?></span>
                </p>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-100 p-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($paidByCurrency)): ?>
                <p class="text-2xl font-bold text-gray-300">—</p>
            <?php else: ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $paidByCurrency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cur => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <p class="font-bold text-teal-600 <?php echo e($multiCurrency ? 'text-lg' : 'text-2xl'); ?>">
                    <?php echo e(number_format($amount, 0)); ?>
        ...
        <div class="bg-white rounded-xl border border-gray-100 p-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($outstandingByCurrency)): ?>
                <p class="text-2xl font-bold text-gray-300">✓</p>
                <p class="text-xs text-teal-500 mt-0.5">لا يوجد مستحق</p>
            <?php else: ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $outstandingByCurrency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cur => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <p class="font-bold text-red-600 <?php echo e(count($outstandingByCurrency) > 1 ? 'text-lg' : 'text-2xl'); ?>">
                    <?php echo e(number_format($amount, 0)); ?>
        ...
        <div class="bg-white rounded-xl border border-gray-100 p-4 col-span-1">
            <div class="flex items-center justify-between mb-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hsScore !== null): ?>
                <span class="text-xs px-2 py-0.5 rounded-full font-medium <?php echo e($hsBg); ?> <?php echo e($hsColor); ?>">
                    <?php echo e($hs?->grade()->label() ?? ''); ?>

                </span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <p class="text-3xl font-bold <?php echo e($hsColor); ?>">
                <?php echo e($hsScore ?? '—'); ?><span class="text-sm font-normal text-gray-400">/100</span>
            </p>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($factors)): ?>
            <div class="mt-3 space-y-1.5">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $factorLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => [$label, $weight]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $val = $factors[$key] ?? 0; ?>
                <div>
                    <div class="flex justify-between text-xs text-gray-500 mb-0.5">
                        <span><?php echo e($label); ?></span>
                        <span class="font-medium text-gray-700"><?php echo e($val); ?>%</span>
                    </div>
                    <div class="w-full h-1.5 bg-gray-100 rounded-full overflow-hidden">
                        <div class="h-full rounded-full transition-all duration-500
                            <?php echo e($val >= 75 ? 'bg-teal-500' : ($val >= 50 ? 'bg-amber-400' : 'bg-red-400')); ?>"
                             style="width: <?php echo e($val); ?>%"></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($multiCurrency): ?>
    ...
    <div x-data="{ tab: '<?php echo e(request()->get('tab', 'activity')); ?>' }">
        ...
        <div x-show="tab === 'tags'" class="pt-4 space-y-4">
            ...
            <div class="bg-white rounded-xl border border-gray-100 p-5">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <div class="flex items-center gap-1.5 pl-2 pr-3 py-1.5 rounded-full text-sm font-medium text-white"
                         style="background-color: <?php echo e($tag->color ?? '#6366f1'); ?>">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tag->icon): ?><span><?php echo e($tag->icon); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <span><?php echo e($tag->name); ?></span>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $client)): ?>
                        <form method="POST" action="<?php echo e(route('clients.tags.remove', [$client->public_id, $tag->id])); ?>"
                              x-on:submit.prevent="
                                fetch($el.action, {
                                    method: 'POST',
                                    headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' }
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $client)): ?>
            <?php $availableTags = $allTags->whereNotIn('id', $client->tags->pluck('id')); ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($availableTags->isNotEmpty()): ?>
            <div class="bg-white rounded-xl border border-gray-100 p-5">
                <h3 class="text-sm font-semibold text-gray-700 mb-3">إضافة وسم</h3>
                <div class="flex flex-wrap gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $availableTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <form method="POST" action="<?php echo e(route('clients.tags.assign', [$client->public_id, $tag->id])); ?>"
                          x-on:submit.prevent="
                            fetch($el.action, {
                                method: 'POST',
                                headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' }
                        ...
                        <button type="submit"
                                ...
                                style="border-color: <?php echo e($tag->color ?? '#6366f1'); ?>; color: <?php echo e($tag->color ?? '#6366f1'); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tag->icon): ?><span><?php echo e($tag->icon); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php echo e($tag->name); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($tagSuggestions)): ?>
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <form method="POST" action="<?php echo e(route('clients.tags.assign', [$client->public_id, $suggestion->id])); ?>"
                        ...
                        <button type="submit"
                            ...
                            <span class="w-2.5 h-2.5 rounded-full" style="background:<?php echo e($suggestion->color ?? '#6366f1'); ?>"></span>
...
function clientProfile() {
    return {
        ...
        async loadTimeline(append) {
            ...
            try {
                let url = '<?php echo e(route('clients.timeline', $client->public_id)); ?>';
