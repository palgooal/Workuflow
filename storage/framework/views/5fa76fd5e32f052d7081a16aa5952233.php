        ...
        <form method="GET" action="<?php echo e(route('clients.index')); ?>" class="flex flex-wrap gap-3 items-end">
            ...
            <div class="flex-1 min-w-48">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="search" id="liveSearch" value="<?php echo e($filters->search); ?>"
        ...
        <div class="flex items-center gap-2 mr-auto">
            ...
            <div class="relative" x-data="{ openTag: false }">
                ...
                <div x-show="openTag" x-on:click.away="openTag=false"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button x-on:click="bulkAction('tag', <?php echo e($tag->id); ?>); openTag=false"
                            class="w-full text-right px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 flex items-center gap-2">
                        <span class="w-3 h-3 rounded-full inline-block" style="background:<?php echo e($tag->color ?? '#6366f1'); ?>"></span>
                        <?php echo e($tag->name); ?>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50 transition group"
                        :class="selectedIds.includes(<?php echo e($client->id); ?>) ? 'bg-indigo-50/50' : ''">
                        <td class="py-3 px-3">
                            <input type="checkbox"
                                   value="<?php echo e($client->id); ?>"
                                   x-on:change="toggleClient(<?php echo e($client->id); ?>, $event.target.checked)"
                                   :checked="selectedIds.includes(<?php echo e($client->id); ?>)"
                                   class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                        </td>
...
window.clientList = function() {
    return {
        // ── State ────────────────────────────────────────────────────
        selectedIds:  [],
        visibleCount: <?php echo e($clients->count()); ?>,
        hasMore:      <?php echo e($clients->hasMorePages() ? 'true' : 'false'); ?>,
        nextCursor:   '<?php echo e($clients->nextCursor()?->encode() ?? ''); ?>',
        loadingMore:  false,
        searching:    false,
        currentSearch: '<?php echo e($filters->search ?? ''); ?>',
        ...
        async loadMore() {
            ...
            try {
                ...
                const res  = await fetch(`<?php echo e(route('clients.index')); ?>?${params}`, {
        ...
        async bulkAction(action, tagId = null) {
            ...
            try {
                ...
                const res  = await fetch('<?php echo e(route('clients.bulk-action')); ?>', {
                    method: 'POST',
                    headers: {
