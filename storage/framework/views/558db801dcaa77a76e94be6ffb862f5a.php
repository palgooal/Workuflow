<div class="bg-white rounded-2xl border border-gray-100 hover:shadow-md transition-shadow
            <?php echo e($project->status->isActive() ? '' : 'opacity-70'); ?>"
     x-data="{ menuOpen: false, statusOpen: false }">

    
    <div class="h-1.5 w-full rounded-t-2xl" style="background-color: <?php echo e($project->color); ?>"></div>
    ...
    <div class="p-5">
        <div class="flex items-start justify-between gap-3">
            <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-xs text-gray-400 mt-0.5"><?php echo e($project->currency); ?></p>
                </div>
            </div>
                ...
                <div x-show="menuOpen" x-transition
                    ...
                    <button type="button" @click="statusOpen = !statusOpen"
                        ...
                        <span class="flex items-center gap-2">
                            <span><?php echo e($project->status->icon()); ?></span>
                            <span><?php echo e($project->status->label()); ?></span>
                        </span>
                    ...
                    <div x-show="statusOpen" x-transition class="bg-gray-50 border-t border-b border-gray-100 py-1">
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $allStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($s !== $project->status): ?>
                            <form method="POST" action="<?php echo e(route('projects.update-status', $project)); ?>">
                                <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                <input type="hidden" name="status" value="<?php echo e($s->value); ?>">
                                <button type="submit"
                                        class="w-full flex items-center gap-2.5 px-4 py-1.5 text-xs text-gray-600 hover:bg-white hover:text-gray-900 transition">
                                    <span><?php echo e($s->icon()); ?></span>
        ...
        <div class="mt-2">
            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-bold <?php echo e($project->status->tailwindBadge()); ?>">
